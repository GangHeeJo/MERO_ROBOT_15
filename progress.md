...
| 품목 | 제품명 | 용도 | 금액 |
|------|--------|------|------|
| 파워뱅크 | 모루이 MT-65 65W 20000mAh (쿠팡) | 젯슨 전원 | 34,800원 |
| PD 트리거 케이블 | USB-C PD → DC 5.5×2.5mm 20V (디바이스마트) | 파워뱅크 → 젯슨 배럴잭 | 15,900원 |
| | | **주문 합계** | **50,700원** |
...
| 품목 | 제품명 | 용도 | 금액 |
|------|--------|------|------|
| OpenRB-150 | ROBOTIS OpenRB-150 | Dynamixel 컨트롤러 (젯슨↔팔·그리퍼) | 27,500원 |
| LiPo 배터리 | MJX 3S 11.1V 2500mAh | Dynamixel 전원 (XL430+XC330) | 29,300원 |
| LiPo 충전기 | SKYRC E3 2S/3S 밸런스 충전기 | LiPo 충전 | 36,300원 |
| 딘스 케이블 | T플러그 수컷 피그테일 4개입 | LiPo → OpenRB 초록 단자 연결 | 9,500원 |
| | | **예정 합계** | **102,600원** |
