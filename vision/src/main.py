...
MODEL_PATH = os.path.join(BASE_DIR, "model", "best.pt")  # TensorRT 변환 생략, PyTorch 원본 직접 사용(속도는 느림)
# TensorRT 변환본 쓸 때: MODEL_PATH = os.path.join(BASE_DIR, "model", "best.engine")
